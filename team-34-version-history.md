...
| 2025/04/29 | 1.2.8   | Felix Schafer | added API collection of course and job data |
| 2025/04/30 | 1.2.9   | Felix Schafer | refactored lsu data collection to avoid collecting and storing unneeded repeat data |
